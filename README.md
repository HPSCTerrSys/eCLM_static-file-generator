...
Please check the documentation at https://hpscterrsys.github.io/eCLM_static-file-generator/INDEX.html

## License
eCLM atmospheric forcing generator is open source software and is licensed under the [MIT-License](https://github.com/HPSCTerrSys/eCLM_static-file-generator/blob/master/LICENSE).
